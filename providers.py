...
PROVIDERS: list[Provider] = [
    ...
    Provider(
        ...
        free_limits="500 RPD Flash, 100 RPD Pro",
        models=["gemini-2.5-flash", "gemini-2.5-pro", "gemini-2.0-flash"],
        signup_url="https://aistudio.google.com",
        test_model="gemini-2.0-flash",
        notes="Free tier is very generous (500 RPD for Flash). Supports OpenAI SDK via compatibility layer.",
    ),
    Provider(
        name="Groq",
        tier=Tier.FREE,
    ...
    Provider(
        ...
        free_limits="28+ free models, 20 RPM / 200 RPD",
        models=["deepseek/deepseek-r1:free", "qwen/qwen3-coder-480b-a35b:free", "meta-llama/llama-3.3-70b-instruct:free", "qwen/qwen3-235b-a22b:free"],
        signup_url="https://openrouter.ai",
        test_model="deepseek/deepseek-r1:free",
        notes="Aggregator with 28+ permanently free models incl. Qwen3 Coder 480B, Trinity-Large-Preview, StepFun Step 3.5 Flash.",
    ),
    Provider(
    ...
    Provider(
        ...
        env_key=None,
        auth_style="none",
        free_limits="Unlimited (no API key needed)",
        models=["gpt-4o-mini", "claude-3.5-sonnet", "gemini-2.0-flash"],
        openai_compatible=False,
        signup_url="https://puter.com",
        test_model="gpt-4o-mini",
        notes="Free unlimited access to GPT-4o-mini, Claude 3.5, Gemini via puter.js SDK. Web/Node.js only.",
    ),
    Provider(
        name="Reka AI",
        tier=Tier.FREE,
        ...
        free_limits="$10/mo free credits",
        models=["reka-flash", "reka-core"],
        signup_url="https://platform.reka.ai",
        test_model="reka-flash",
        notes="Multimodal AI. OpenAI-compatible. $10/mo free credits renewable.",
    ),
    Provider(
        name="Arcee AI",
        tier=Tier.FREE,
        ...
        free_limits="Free via OpenRouter",
        models=["arcee-ai/trinity-large-preview", "arcee-ai/caller-large"],
        signup_url="https://arcee.ai",
        test_model="arcee-ai/trinity-large-preview",
        notes="Trinity-Large-Preview is free on OpenRouter. Specializes in enterprise AI.",
    ),
    ...
    Provider(
        ...
        free_limits="Free on OpenRouter (Step 3.5 Flash)",
        models=["step-3-flash", "step-3-mini"],
        signup_url="https://platform.stepfun.com",
        test_model="step-3-flash",
        notes="Chinese AI lab. Step 3.5 Flash is a 196B MoE model, free via OpenRouter.",
    ),
    Provider(
        name="LemonData",
        tier=Tier.GENEROUS_FREE,
        endpoint="https://api.lemondata.ai/v1",
        env_key="LEMONDATA_API_KEY",
        free_limits="$1 credits, 300+ models",
        models=["gpt-4o", "claude-3.5-sonnet", "llama-3.3-70b"],
        signup_url="https://lemondata.ai",
        test_model="llama-3.3-70b",
        notes="Aggregator with 300+ models. $1 free credits on signup.",
    ),
    ...
    Provider(
        name="Baseten",
        tier=Tier.FREE_CREDITS,
        endpoint="https://model-{model_id}.api.baseten.co/v1",
        env_key="BASETEN_API_KEY",
        free_limits="$30 credits",
        models=["llama-3.3-70b", "deepseek-r1", "custom deploy"],
        signup_url="https://baseten.co",
        test_model="",
        notes="Deploy and serve any model. $30 free credits. OpenAI-compatible.",
    ),
    Provider(
        name="Modal",
        tier=Tier.FREE_CREDITS,
        endpoint="https://YOUR_APP.modal.run/v1",
        env_key="MODAL_TOKEN_ID",
        free_limits="$30/mo free compute",
        models=["Any (self-deployed)", "vLLM templates"],
        signup_url="https://modal.com",
        test_model="",
        notes="Serverless GPU platform. $30/mo free. Great for custom model serving with vLLM.",
    ),
    Provider(
        ...
        signup_url="https://app.endpoints.anyscale.com",
        test_model="meta-llama/Llama-3.3-70B-Instruct",
        notes="Ray-based serving. Fast open-source model inference.",
    ),
